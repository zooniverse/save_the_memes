...
(function() {
  var CAMPAIGN_PROGRESS, CAMPAIGN_TOTAL, formatNumber, loadKey, serengetiImages;
  ...
  $(function() {
    var column, downloadButton, form, fragment, handleGenerate, happyStoryBackground, i, imageContainer, imageUrlInput, img, isHappy, navigation, progressAmount, progressContainer, randomElement, sadStoryBackground, setMeter, stage, storyButton, url, _i;
    $.scrollIt();
